...
label0 = Label(root, text="INTRUSION DETECTION SYSTEM",bg='pink',font=('Times 23 bold'))
label0.pack(side=TOP)

label1=Label(text="Potential Intruders",bg='pink',font=('Times 15 bold'))
...
label2=Label(text="Mode of operation",bg='pink',font=('Times 15 bold'))
...
def camera():
    ...
    if(combo2.get()=="webcam"):
        ip_address=0
        but3=Button(root,padx=5,pady=5,width=42,bg='white',fg='black',relief=GROOVE,command=lambda:intrusion(ip_address,intrusion_type),text='Run Intrusion Detection',font=('Times 15 bold'))
        but3.place(x=5,y=300)
    elif(combo2.get()=="CCTV"):
        label3=Label(text="Enter the ip address of CCTV camera",bg='pink',font=('Times 15 bold'))
        ...
        def get_ip():
            ...
            but3=Button(root,padx=5,pady=5,width=42,bg='white',fg='black',relief=GROOVE,command=lambda:intrusion(ip_address,intrusion_type),text='Run Intrusion Detection',font=('Times 15 bold'))
            but3.place(x=5,y=300)
        but2=Button(root,width=5,bg='white',fg='black',relief=GROOVE,command=get_ip,text='Enter',font=('Times 8 bold'))
        ...
        label4=Label(text="Enter the video path",bg='pink',font=('Times 15 bold'))
...
but1=Button(root,width=7,bg='white',fg='black',relief=GROOVE,command=camera,text='Enter',font=('Times 9 bold'))
but1.place(x=450,y=128)

def exit():
   root.destroy()

but5=Button(root,padx=5,pady=5,width=42,bg='white',fg='black',relief=GROOVE,text='EXIT',command=exit,font=('Times 15 bold'))
        ...
        if ret:
            ...
            for color, result in zip(colors, results):
                ...
                if label== intrusion_type:              
                    ...
                    b=int((int(result['topleft']['y'])+int(result['bottomright']['y']))/2)
